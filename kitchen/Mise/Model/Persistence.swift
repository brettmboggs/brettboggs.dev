...
enum Persistence {
    static var directory: URL {
        ...
        return base.appendingPathComponent("Mise", isDirectory: true)
    }
    ...
    static func save<T: Encodable>(_ value: T, to name: String) {
        ...
        do {
            ...
            NSLog("Mise: could not save \(name): \(error.localizedDescription)")
        }
    }
}
...
enum PhotoStore {
    ...
    static func save(data: Data, id: String) -> Bool {
        do {
            ...
            NSLog("Mise: could not save photo: \(error.localizedDescription)")
            return false
        }
    }
