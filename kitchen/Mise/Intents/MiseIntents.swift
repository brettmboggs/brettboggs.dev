...
/// The cook-mode commands, so "Hey Siri, next step in Mise" works with the
...
struct StartTimerIntent: AppIntent {
    ...
    static var description = IntentDescription("Starts a timer in Mise.")
...
struct AddToShoppingListIntent: AppIntent {
    ...
    static var description = IntentDescription("Puts something on the Mise shopping list.")
