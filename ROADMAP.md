...
| 3  | Case studies as decision logs    | LIVE    | All three written and live as unlisted pages, linked from /work/datum/: tenant-isolation.md, session-prompting.md, erp-writeback.md in src/content/work/. Unlisted on purpose, so they stay off the work index. |
